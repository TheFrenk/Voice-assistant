...
commands = ['текущее время', 'сейчас времени', 'который час',
            ...
            'пока', 'вырубись', 'выключись',
            'выключи компьютер', 'выруби компьютер',
            'комманды', 'что ты умеешь',
            'открой ютуб',
            'открой стим']
...
cmds = {
    ...
    'пока': quite, 'вырубись': quite, 'выключись': quite,
    'выключи компьютер': shut, 'выруби компьютер': shut,
    'комманды': all_commands, 'что ты умеешь': all_commands,
